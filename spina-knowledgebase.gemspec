...
require 'spina/knowledgebase/version'

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = 'spina-knowledgebase'
  s.version     = Spina::Knowledgebase::VERSION
  s.authors     = ['Tom Simnett']
  s.email       = ['tom@initforthe.com']
  s.homepage    = 'https://github.com'
  s.summary     = 'Knowledgebase Engine for Spina CMS'
  s.description = 'Knowledgebase Engine for Spina CMS comprising categories and articles'
  s.license     = 'MIT'
